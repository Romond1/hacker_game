import { keyboardMissions } from './keyboard-missions';
...
export const MISSIONS = [missionOne, missionTwo, scrollMission, dragMission, contextMission, missionFour, recoveryMission, missionThree, ...keyboardMissions] as const;
