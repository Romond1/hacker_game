export const robotDefenseModes = [
  ...
  { id: 'robot_untangle', name: 'Robot Link', requiredMission: 4, trainingNumber: 5, support: { it: 'Collega Robot', ja: 'ロボット リンク' }, skill: { en: 'Right-click to unlink robots, then double-click to restore.', it: 'Clic destro per scollegare i robot, poi doppio clic per ripristinare.', ja: 'みぎクリックで リンクを かいじょ、ダブルクリックで なおそう。' } },
